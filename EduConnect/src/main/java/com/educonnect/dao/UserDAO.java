...
// =================================================|| EDIT USER FUNCTION START ||=============================================================//
	...
	public boolean updateUser(User user) {
		try {
			...
			//String sql = "UPDATE users SET firstname=?, lastname=?, email=?, role=?, gender=?, password=?, dob=?, profile_photo=?, grade=?, parent_name=?, parent_contact=?, type=?, date_of_work_start=?, subject=?, education_qualification=?, join_date=? WHERE id=?";
